    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          ...
          <div className="card text-center">
            ...
            <p className="text-2xl font-bold text-emerald-400">${jackpot}</p>
          </div>
          <div className="card text-center">
      ...
      <footer className="border-t border-white/10 py-6 mt-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          {/* Share prompts */}
          <p className="text-gray-400 text-sm mb-4">Know someone who'd want to play?</p>
          <div className="flex justify-center gap-3 mb-6">
            <a 
              href={`sms:?body=Check out this raffle! ${typeof window !== 'undefined' ? window.location.href : ''}`}
          ...
          <p className="text-gray-500 text-xs">
            Fiddyfiddy • Must be 18+ • Not available in AL, HI, UT
          </p>
          <p className="text-gray-600 text-xs mt-2">
            <Link href="/about" className="hover:text-gray-400">Learn More</Link>
            {' • '}
            <Link href="/lobby" className="hover:text-gray-400">All Raffles</Link>
          </p>
        </div>
      </footer>
    </div>
